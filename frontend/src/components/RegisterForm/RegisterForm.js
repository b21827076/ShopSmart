...
const RegisterForm = () => {
  ...
  const roleCheck = (role) => {
    if (role.toLowerCase() === "merchant") return true;
    if (role.toLowerCase() === "customer") return true;
    if (role.toLowerCase() === "community moderator") return true;
  ...
  const roleFormatter = (role) => {
    if (role.toLowerCase() === "merchant") return "ROLE_MERCHANT";
    if (role.toLowerCase() === "customer") return "ROLE_CUSTOMER";
    if (role.toLowerCase() === "community moderator")
      return "ROLE_COMMUNITY_MODERATOR";
    if (role.toLowerCase() === "admin") return "ROLE_ADMIN";
  };
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="selectorDiv">
              ...
              >
                ...
                <option value="#">Community Moderator</option>
            ...
            {(token === null || (user && user.roles[0] !== "ROLE_ADMIN")) && (
              <h4>
                ...
                <Link className="link-1" to="/auth/login">
                  Log In
                </Link>{" "}
              </h4>
            )}
