...
const EditProfile = (props) => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8080/api/editProfile/${profilename}`, opts)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const saveHandler = () => {
    ...
    fetch("http://localhost:8080/api/editProfile/update/about", opts)
      .then((res) => {
        return res;
      })
      .then((data) => {})
        ...
        <div className="EditProfileRight">
          <div className="EditProfileRightTop">
            <div className="EditProfileCover">
              <img className="EditProfileCoverImg" src={banner} alt="" />
              <div className="EditprofileRateStars">
                <RatingStars
                  username={profilename}
